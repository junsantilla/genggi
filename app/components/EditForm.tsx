    ...
    return (
        <form action={formAction} className="grid grid-cols-2 gap-2.5">
            ...
            <div>
                ...
                <input
                    name="favoriteSong"
                    defaultValue={user.favoriteSong}
                    className="input"
            ...
            <div>
                ...
                <input
                    ...
                    className="input"
                    placeholder="AIM, mix CDs, LAN parties"
                />
            </div>
            <div className="col-span-2">
                ...
                <input
                    name="hereFor"
                    defaultValue={user.hereFor}
                    className="input"
                    placeholder="Friends, Dating, Networking"
                />
            </div>
            <div className="col-span-2">
            ...
            <div className="col-span-2">
                ...
                <textarea
                    ...
                    defaultValue={user.whoIdLikeToMeet}
                    rows={3}
                    className="input"
                />
            </div>
            <div className="col-span-2">
                {state.error && (
                    <div className="text-red-600  font-bold bg-red-50 border border-red-200 px-2 py-1 mb-2">
                        {state.error}
                    </div>
                )}
                {state.ok && (
                    <div className="text-green-700  font-bold bg-green-50 border border-green-200 px-2 py-1 mb-2">
                        Saved!
                    </div>
                )}
                <button
