...
export default function AuthPageShell({
    ...
    return (
        <div className="auth-page relative flex min-h-[calc(100dvh-53px)] flex-1 flex-col items-center justify-start overflow-x-hidden overflow-y-auto px-2.5 py-6 sm:justify-center sm:py-12">
            {showMasonry && <MasonryBackground />}

            <div className={`relative z-10 flex w-full ${wide ? "max-w-[960px]" : "max-w-[440px]"} flex-col items-center justify-start px-2.5 py-2 sm:flex-1 sm:justify-center sm:py-8`}>
                <div className={`auth-card mx-auto w-full ${wide ? "max-w-[960px]" : "max-w-[440px]"} border border-[#6699cc] bg-white shadow-lg`}>
                    {showTitle && title && (
