...
export default function Landing({ border = "#6699cc" }: { border?: string }) {
    return (
        <div className="max-w-[960px] w-full mx-auto bg-white border border-[#6699cc] sm:border-x">
            <div className="bg-gradient-to-b from-[#4a76b8] to-[#2c4d80] text-white px-4 py-6 text-center hidden">
                <h1 className="font-['Comic_Sans_MS',cursive,sans-serif] text-3xl sm:text-4xl m-0 mb-1 tracking-tight">
                    🤙 Welcome to genggeng
                    <span className="text-[#ffde00]">.pro</span>
                </h1>
                <p className="text-[#dbe9f7] text-sm sm:text-base m-0">
                    The nostalgic social network. Make a profile, add friends,
                    send messages, and collect testimonials — just like the good
                    old days.
                </p>
            </div>
            ...
            <div className="p-2.5">
                <Box title="✨ Features" border={border} bg="#f5f9ff">
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 mb-0.5">
