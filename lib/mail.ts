...
export async function sendVerificationEmail(
  ...
  const { error } = await resend.emails.send({
    from: FROM,
    to,
    subject: "Verify your genggeng.pro email",
    text: `Welcome to genggeng.pro! Please confirm your email by opening this link (valid for 24 hours):\n\n${verifyUrl}\n\nIf you didn't create an account, you can safely ignore this email.`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; border: 1px solid #6699cc;">
        ...
        <div style="padding: 14px; font-size: 13px; color: #333;">
          <p>Thanks for joining genggeng.pro! Please confirm your email address to activate your account.</p>
          <p>
